...
def main(args):
    with open(args.annotations[0], "rt", encoding="UTF-8") as annotations1, open(args.annotations[1], "rt", encoding="UTF-8") as annotations2:
        ...
        print(len(set(im["id"] for im in annotations1)), len(set(im["id"] for im in annotations2)), len(set(im["id"] for im in annotations1+annotations2)))
        print(len(set(im["id"] for im in categories1)), len(set(im["id"] for im in categories2)), len(set(im["id"] for im in categories1+categories2)))
